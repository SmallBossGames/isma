 ...
 * on 30.07.2016.
 */
public class ResultViewConfigurationPanel extends TitledBorderPanel {

    private IsmaEnvironment env;

    private SimulationWindowController controller;

    public ResultViewConfigurationPanel(IsmaEnvironment env, SimulationWindowController controller) {
        super("Result view", Consts.PANELS_ROUND);
