...
dependencies {
    ...
    implementation (project(":isma-intg-server-parent:isma-intg-server-client"))
    implementation (project(":isma-intg-lib-parent:isma-intg-lib"))
    implementation (project(":isma-intg-lib-parent:isma-intg-lib-euler"))
    testImplementation (project(":isma-intg-lib-parent:isma-intg-lib"))
